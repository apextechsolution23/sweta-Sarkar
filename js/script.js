...
function initializeApp() {
    ...
    initSkillBars();        // ✅ Fixed here
    initStatsCounter();     // ✅ Fixed here
    initContactForm();
    initSmoothScrolling();
    initMobileMenu();
}
...
function initTypewriter() {
    ...
    const text = "Hi, I'm Sweta Sarkar - Data Analys";
    let index = 0;
...
// ✅ Fixed Skill Bars for mobile view
function initSkillBars() {
    ...
    }, { threshold: 0.2 }); // ✅ lowered threshold for mobile
...
// ✅ Fixed Stats Counter for mobile view
